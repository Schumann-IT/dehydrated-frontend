 ...
 */
export function instanceOfModelUpdateDomainRequest(value: object): value is ModelUpdateDomainRequest {
    return true;
}

export function ModelUpdateDomainRequestFromJSON(json: any): ModelUpdateDomainRequest {
    return ModelUpdateDomainRequestFromJSONTyped(json, false);
}

export function ModelUpdateDomainRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): ModelUpdateDomainRequest {
    if (json == null) {
        return json;
    }
    return {
...
export function ModelUpdateDomainRequestToJSON(json: any): ModelUpdateDomainRequest {
    return ModelUpdateDomainRequestToJSONTyped(json, false);
}

export function ModelUpdateDomainRequestToJSONTyped(value?: ModelUpdateDomainRequest | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
