 ...
 */
export function instanceOfModelDomainEntry(value: object): value is ModelDomainEntry {
    return true;
}
...
export function ModelDomainEntryFromJSONTyped(json: any, ignoreDiscriminator: boolean): ModelDomainEntry {
    if (json == null) {
        return json;
    }
    return {
...
export function ModelDomainEntryToJSONTyped(value?: ModelDomainEntry | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
